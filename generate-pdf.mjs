 ...
 *
 * Adapted from career-ops. Uses Chromium headless to render HTML and produce
 * clean, ATS-parseable PDFs. Includes Unicode normalization for ATS compatibility.
 *
 * Defaults: letter format, 0.75in margins (legal resume standard).
 */
 ...
 * and non-breaking spaces. Only touches body text — preserves CSS, JS, and
 * tag attributes. Returns { html, replacements } for logging.
 */
